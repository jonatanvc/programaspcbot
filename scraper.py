...
async def obtener_enlace_dinamico(context, url_post):
    ...
    try:
        ...
        if await boton_descarga.count() > 0:
            ...
            selector_enlace_final = "div[class^='version_download'] a[href], a[href*='download/file'], a[href^='magnet:'], a[href$='.zip'], a[href$='.rar'], a[href$='.iso']"
...
async def scrape_filecr():
    ...
    url_apps = "https://filecr.com/ms-windows/"
    resultados = []
