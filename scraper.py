    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            for titulo, url_post in posts_a_procesar:
                ...
                download_url = await obtener_enlace_dinamico(context, url_post)
                ...
                if download_url:
                    resultados.append({
                        ...
                        "url_origen": download_url,
                        "descripcion": f"Software útil para Windows: {titulo}. Paquete limpio verificado con medicina e instrucciones incluidas."
                    })
                    logger.info(f"✅ Descarga indexada correctamente: {titulo}")
