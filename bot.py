    ...
    while True:
        ...
        if len(file_ids) == len(part_paths):
            ...
            if PUBLIC_CHANNEL_ID != 0:
                ...
                import urllib.parse
                safe_title = urllib.parse.quote(prog['titulo'])
                # Generar una miniatura profesional al vuelo con el titulo
                image_url = f"https://placehold.co/800x400/2C3E50/FFFFFF/png?text={safe_title}&font=Montserrat"
...
async def start_command_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if args and args[0].isdigit():
        ...
        if not prog or prog['estado'] != 'Publicado' or not prog['telegram_file_ids']:
