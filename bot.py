...
async def worker_queue_processor():
    while True:
        ...
        if success:
            logger.info("Programa enviado con éxito. Esperando 12 minutos para subir el siguiente...")
            await asyncio.sleep(12 * 60)
        else:
            logger.warning(f"Fallo al descargar/subir {prog['titulo']}. Saltando al siguiente inmediatamente...")
            await asyncio.sleep(10) # Pequeña pausa antes de intentar el siguiente
